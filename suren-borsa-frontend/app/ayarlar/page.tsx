        ...
        <main className="p-6 space-y-6 overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 focus:border-emerald-500 focus:bg-white text-slate-900 p-3 rounded-xl outline-none font-medium"
                  />
                </div>
                ...
                <div className="space-y-1 md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleCompanyChange}
                    className="w-full bg-slate-50 border border-slate-200 focus:border-emerald-500 focus:bg-white text-slate-900 p-3 rounded-xl outline-none font-medium resize-none"
                  />
                </div>
              </div>

              <div className="pt-2 flex justify-end">
                <button type="submit" className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-6 py-2.5 rounded-xl text-xs shadow-sm transition">
          ...
          {activeTab === "bildirim" && (
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-6 max-w-4xl">
              ...
              <div className="pt-2 flex justify-end">
                <button onClick={handleSave} className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-6 py-2.5 rounded-xl text-xs shadow-sm transition">
                  Tercihleri Kaydet
                </button>
              </div>
            </div>
          ...
          {activeTab === "fatura" && (
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-6 max-w-4xl">
              ...
              <div className="bg-emerald-50/60 border border-emerald-100 p-5 rounded-2xl flex flex-wrap items-center justify-between gap-4">
                <div>
                  <span className="bg-emerald-600 text-white text-[10px] font-bold px-2.5 py-1 rounded-md">AKTİF PLAN</span>
                  <h4 className="font-black text-slate-900 text-base mt-1.5">B2B Kurumsal Kurumsal Kurucu Paket</h4>
              ...
              <div className="space-y-3">
                ...
                <div className="border border-slate-200 rounded-xl overflow-hidden text-xs">
                  ...
                  <div className="flex justify-between p-3.5 border-b border-slate-100">
                    ...
                    <span className="text-emerald-600 font-bold">Ödendi ✓</span>
