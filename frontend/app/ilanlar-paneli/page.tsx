      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-slate-200 px-4 sm:px-6 py-3.5 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
          ...
          <Link 
            ...
            className="hover:opacity-90 text-white font-bold px-4 py-2 rounded-xl text-xs transition shadow-sm text-center"
          >
            + Yeni İlan Oluştur
          </Link>
        </header>
                    ...
                    {currentListings
                      ...
                      .map((item: any) => (
                        <tr key={item.id} className="hover:bg-slate-50 transition">
                          <td className="py-3 px-3 font-mono font-bold whitespace-nowrap" style={{ color: "#123873" }}>{item.id}</td>
                          ...
                          <td className="py-3 px-3 text-slate-600 whitespace-nowrap">📍 {item.location}</td>
