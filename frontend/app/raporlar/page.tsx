  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] font-sans flex flex-col lg:flex-row text-slate-800">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="bg-white border-b border-slate-200 px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 print:border-none">
          <div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 print:hidden">
            <select
              ...
              className="bg-slate-50 border border-slate-200 text-xs font-bold px-3.5 py-2.5 rounded-xl outline-none focus:border-[#1E314A] cursor-pointer"
            >
            ...
            <button
              ...
              className="bg-[#1E314A] hover:bg-[#152336] text-white text-xs font-bold px-4 py-2.5 rounded-xl transition shadow-sm flex items-center justify-center gap-1.5"
            >
        ...
        <main className="p-4 sm:p-6 lg:p-8 overflow-y-auto max-w-7xl mx-auto w-full space-y-8">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-xl relative overflow-hidden space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4 relative z-10">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-emerald-500/20 text-emerald-400 flex items-center justify-center text-xl font-bold shrink-0">
                  🌱
                </div>
                <div>
              ...
              <span className="text-[11px] font-bold px-3 py-1 bg-emerald-500/20 text-emerald-300 rounded-full border border-emerald-500/30 self-start sm:self-auto">
            ...
            <div className="bg-slate-950/80 px-4 sm:px-5 py-3 rounded-xl border border-slate-800/80 flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs text-slate-400 gap-2 relative z-10">
              ...
              <div className="font-mono text-[11px] text-slate-500 shrink-0">Endeks: DöngüBorsa ESG v2.4</div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <span className="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-100 self-start sm:self-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-2">
              {categories && categories.length > 0 ? (
                ...
                <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-1.5 col-span-full text-center text-xs text-slate-400">
                  Veriler yükleniyor...
                </div>
              )}
            </div>
